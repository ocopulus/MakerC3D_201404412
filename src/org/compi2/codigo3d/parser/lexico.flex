...
<YYINITIAL> {ANDD}          { return new Symbol(sym.AND, yyline, yycolumn, null); }
<YYINITIAL> {ORR}           { return new Symbol(sym.OR, yyline, yycolumn, null); }
<YYINITIAL> {NOTT}          { return new Symbol(sym.NOT, yyline, yycolumn, null); }
